...
def generate_attack_audio():
    arguments = ['attack_configs/cw.yaml', '--root=', '--data_csv_name=test-clean-20', '--model_label=tiny.en', '--tokenizer_name=gpt2', '--nb_iter=2000', '--load_audio=False', '--seed=2000', '--attack_name=cw', '--eps=0.1', '--const=4', '--max_decr=8', '--lr=0.01', '--confidence=0.0', '--decrease_factor_eps=0.7']
